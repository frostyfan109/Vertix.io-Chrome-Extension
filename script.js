...
chrome.storage.sync.get(['config'],function(data) {
  if ($.isEmptyObject(data)) {
    hackCfg =
      {"aimhacks":true,"botNo":4,"kdFarm":false,"bots":false,"botSpeed":false,"botHostile":true,"kdFarm":false,"globalLocations":true,"noRecoil":false,"hideAimbot":true,"autoFire":true,"speedHacks":true,"collisionOutlines":true,"mouseAssistance":false,"spins":false,"spinsOld":0,"infiniteAmmo":1,"infiniteAmmoOld":1,"adblocker":true,"expand":{"locationDrawer":true,"ammo":true,"bots":true},"locationDrawer":true,"settings":
  ...
  let botSpeedSwitch = eSwitch("Bot Speed Hacks",$("#botUI"),hackCfg.botSpeed,function(state) {
    updateCfg("botSpeed",state);
  });
  ...
  botSpeedSwitch[2].css({"margin-top":"6px"});
  ...
  botSpeedSwitch[2].detach().insertAfter(kdSwitch[2]);
  botSpeedSwitch[0].css("transform","scale(.75) translate(-25%,25%)");
  botSpeedSwitch[2].find("label").css("margin-left","-5px");
  botSpeedSwitch[2].css("margin-left","2.5px");

  $(`<span>Number of bots:</span><input style='margin-left:10px;border:none;border-bottom:1px solid black;outline:none;display:inline;width:15%;' id='botNum' maxlength='1' type='number'></input>`).insertAfter(botSpeedSwitch[2]);
